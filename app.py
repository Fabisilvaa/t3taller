...
import re
import os
from funciones import relevant, generate_completion, gen_answer_aux, vectorizar, vector_query
...
last_request = 0 
movie_name = None
movie_cache = {} #guardar nombre de pelis usadas
...
def generate_answer(query, movie_name):
    ...
    movie_seg=gen_answer_aux(movie_name, movie_cache)
